  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 text-white">
      <div className="container py-16 md:py-24">
        <p className="mx-auto flex w-fit rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-cyan-200">
          SnapLocal AI Website Builder
        </p>
        <h1 className="mt-5 max-w-3xl text-center text-4xl font-black tracking-tight md:mx-auto md:text-6xl">
          Your website live in 30 seconds.
        </h1>
        <p className="mt-4 max-w-2xl text-center text-zinc-300 md:mx-auto md:text-lg">
